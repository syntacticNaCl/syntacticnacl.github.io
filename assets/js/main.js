...
jQuery(function ($) {
    ...
    $('#terminal').terminal({
        ...
        work: function () {
            this.echo('I did software support for 3.5 years while I was in school. I have worked as a consultant and software engineer at various companies, including most recently as a senior engineer at Foreground. I am currently a Staff Product Security Engineer at Calendly.', {keepWords: true});
        },
        whoami: function () {
        ...
        cves: function () {
            this.echo('CVE publication: CVE-2024-8796', {keepWords: true});
        },
        education: function () {
...
function showHelp(obj) {
    ...
    obj.echo("\t[[g;#c1e1a6;]cves]        my published CVEs");
